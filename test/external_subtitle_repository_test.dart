...
void main() {
  group('ExternalSubtitleRepository', () {
    ...
    test(
      'getSubtitles returns subtitle tracks for valid IMDb movie ID',
      () async {
    ...
    test(
      'getSubtitles returns subtitle tracks for valid IMDb series ID',
      () async {
        // tt0903747 is Breaking Bad, Season 1 Episode 1
        final tracks = await repository.getSubtitles(
          'tt0903747',
          season: 1,
          episode: 1,
        );
