...
class _SearchScreenState extends State<SearchScreen> {
  ...
  final Map<String, ScrollController> _filterControllers = {};
                            ...
                            if (event is KeyDownEvent &&
                              ...
                              if (_showFilters &&
                                ...
                                return KeyEventResult.handled;
                                  ...
                                  _firstMovieFocusNode.canRequestFocus) {
                                _firstMovieFocusNode.requestFocus();
                                return KeyEventResult.handled;
                              }
                            }
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: config.fields.map((field) {
                              ...
                              final controller = _filterControllers[field.key]!;
                              ...
                              return Padding(
                                ...
                                child: SizedBox(
                                  height:
                                      52, // Increased from 44 to fit scrollbar
                                  child: Scrollbar(
                                          ...
                                          return Padding(
                                            ...
                                            child: StatefulBuilder(
                                              builder: (context, setState) {
                                                return Focus(
                                                  focusNode:
                                                      (config!.fields.indexOf(
                                                                field,
                                                              ) ==
                                                              0 &&
                                                          optIndex == 0)
                                                      ? _firstFilterFocusNode
                                                      : null,
                                                  onFocusChange: (focused) =>
                                                      setState(
                                                        () =>
